    ...
    <div class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
        ...
        <form action="" class="my-10">
            <div class="flex flex-col space-y-5">
                ...
                <p class="text-center">Aun no tienes una cuenta? <Link to={REGISTER_URL} class="text-indigo-600 font-medium inline-flex space-x-1 items-center"><span>Registrate ahora! </span><span><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
